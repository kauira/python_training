...
class Application:
    ...
    def create_contant(self, contact):
        wd = self.wd
        # fill firstaname
        ...
        wd.find_element_by_css_selector(f"select[name=\"aday\"] > option[value=\"{contact.aday}\"]").click()
        # select anniversary month
        wd.find_element_by_name("amonth").click()
        Select(wd.find_element_by_name("amonth")).select_by_visible_text(contact.amonth)
        wd.find_element_by_css_selector(f"select[name=\"amonth\"] > option[value=\"{contact.amonth}\"]").click()
