...
class AddContact(unittest.TestCase):
    ...
    def create_contant(self, wd, contact):
        # fill firstaname
    ...
    def test_add_contact(self):
        ...
        self.create_contant(wd, Contant(firstname="ggg", middlename="fgh",lastname="dfg", nickname="rgrgrg", title="dfgd", company="erferfer", address="dfgdgdd", home="dfgdfg", mobile="dgdgdgd",
